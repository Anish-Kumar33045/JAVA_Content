...
public class FileCreation {
    ...
    public void newFile() {
        ...
        try {
            ...
            // works for all OS , make sure  strFilePath ends with / or \\ 
            // windows : \\users\\\folders ('\' for escape character)  Linux,Mac : /Users/Folder
    ...
    public static void main(String args[]) {
        // Creating File Object
        FileCreation gfg = new FileCreation();
        gfg.newFile(); // Creating New File via function
