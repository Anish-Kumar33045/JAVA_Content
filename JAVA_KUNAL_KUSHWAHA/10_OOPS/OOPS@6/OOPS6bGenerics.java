...
public class OOPS6bGenerics{
  
    private int[] data;
    private static int DEFAULT_SIZE = 3;
    private int size = 0;

    public  OOPS6bGenerics() {
   ...
   public int get(int index){
    ...
    public static void main(String[] args) {
      ...
      OOPS6a list = new OOPS6a();
        ...
        list.add(6);
        list.add(89);
        // when the ArrayList is 
        //full then it doubles its size , copies the older element , 
        //and add new element to the new Arraylist 
